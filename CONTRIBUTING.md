# Contributing to uco-identity

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to uco-identity. 
...
The uco-identity team strives to create a
...
Please use our [Issue Tracker](https://github.com/lmodel/uco-identity/issues/) for reporting problems with the ontology. 
