...
# Generation date: 2023-02-28T23:31:05
# Schema: uco-identity
#
...
SCHEMA_LOCATION = CurieNamespace('schema_location', 'https://w3id.org/lmodel/uco-location/schema/')
...
slots.hasFacet = Slot(uri=CORE.hasFacet, name="hasFacet", curie=CORE.curie('hasFacet'),
                   model_uri=IDENTITY.hasFacet, domain=Facet, range=Optional[str])
